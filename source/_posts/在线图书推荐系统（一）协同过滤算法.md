...
经过处理，现在我们得到一个 tuple ， 包含 (UserID, BookID, Rating)
...
经过处理，现在我们得到一个 tuple ， 包含 (ISBN，Book-Title，Book-Author，Year-Of-Publication，Publisher，Image-URL-L)
